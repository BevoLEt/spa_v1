...
db.once('open', function callback () {
	...
	EdisonSchema=require('./models').createEdisonSchema(mongo);
	TempSchema=require('./models').createTempSchema(mongo);
...
app.use('/users',require('./api/user')); //users 들어오는 요청에대해 /api/user 을 사용한다.