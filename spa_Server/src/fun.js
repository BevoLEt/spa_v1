...
function getScienceAppName () { 
    ...
    {
    $.ajax({
        url : "http://"+ip+":"+port+"/spa/scienceAppName/"+cluster_name,
        type:'GET',
        dataType:'json',
        // 서버로 값을 성공적으로 넘기면 처리하는 코드부분 입니다.
        success : function (data) {
...
function getParameter () { 
    ...
    {
    $.ajax({
        url : "http://"+ip+":"+port+"/spa/parameter/"+cluster_name+"/"+scienceappname_name,
        type:'GET',
        dataType:'json',
        // 서버로 값을 성공적으로 넘기면 처리하는 코드부분 입니다.
        success : function (data) {
...
function getResult() { 
    ...
    ///cluster/:cluster_name/:scienceAppName
    $.ajax({
        url : "http://"+ip+":"+port+"/spa/predictResult/"+cluster_name+"/"+scienceappname_name+"/parameters_values"+parameters_values,
        type:'GET',
        dataType:'json',
...
function getResult_statistics() { 
    ...
    $.ajax({
        ...
        success : function (data) {
            ...
            $.ajax({
                url : "http://"+ip+":"+port+"/spa/statisticsResult/"+cluster_name+"/"+scienceappname_name,
                type:'GET',
                dataType:'json',
